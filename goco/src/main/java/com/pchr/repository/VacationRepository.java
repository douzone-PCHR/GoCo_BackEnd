...
public interface VacationRepository extends JpaRepository<Vacation, Long> {
	...
	public List<Vacation> findAllByEmployeeEmpNumOrderByVacationRequestDateDesc(Long empNum);

	// 휴가리스트 조회 (팀장)
	public List<Vacation> findAllByEmployeeUnitUnitIdOrderByVacationRequestDateDesc(Long unitId);
